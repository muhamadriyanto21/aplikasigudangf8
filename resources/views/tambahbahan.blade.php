...
<html lang="en">
  ...
  <body>
    <div class="container">
        <div class="row mt-3">
            <div class="col-12">
                <h1 class="text-center">Tambah Data Bahan</h1>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                  <form action="/insertdata" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="number" name="masuk" class="form-control" id="exampleInputPassword1">
                    </div>
                    <div class="mb-3">
                      <label for="exampleInputPassword1" class="form-label">Keluar</label>
                      <input type="number" name="keluar" class="form-control" id="exampleInputPassword1">
                    </div>
                    <div class="mb-3">
